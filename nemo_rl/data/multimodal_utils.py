...
class PackedTensor:
    ...
    def broadcast_parts(self, device: Any) -> tuple[dict[str, Any], torch.Tensor]:
        ...
        return {
            ...
            "segment_provenance": self._segment_provenance,
        }, payload

    @classmethod
    def from_broadcast_parts(
        cls, metadata: dict[str, Any], payload: torch.Tensor
    ) -> "PackedTensor":
